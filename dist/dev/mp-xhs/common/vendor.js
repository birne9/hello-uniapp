...
let deviceId;
function useDeviceId(global2 = xhs) {
...
function initUni(api, protocols2, platform2 = xhs) {
  ...
  {
    platform2.getEventChannel = getEventChannel;
  }
...
function callHook(name, args) {
  ...
  {
    if (name === "onLoad" && args && args.__id__ && isFunction(xhs.getEventChannel)) {
...
const S = true, b = "mp-xhs", A = I([]), P = b, T = I(""), C = I("[]") || [];
let O = "";
try {
  O = "";
} catch (e2) {
