...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    ...
    k: common_vendor.o(($event) => $data.fileLists = $event),
    l: common_vendor.p({
      readonly: true,
      imageStyles: $data.imageStyles,
      ["file-mediatype"]: "image",
    ...
    m: common_vendor.o(($event) => $data.fileLists = $event),
    n: common_vendor.p({
      readonly: true,
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "/Users/birne/Desktop/mp-weixin/src/pages/extUI/file-picker/file-picker.vue"]]);
