  ...
  return {
    ...
    e: common_vendor.f($data.tableData, (item, index, i0) => {
      return {
        ...
        b: "3a1daf9c-7-" + i0 + "," + ("3a1daf9c-6-" + i0),
        c: common_vendor.t(item.name),
        d: "3a1daf9c-8-" + i0 + "," + ("3a1daf9c-6-" + i0),
        e: common_vendor.t(item.address),
        f: "3a1daf9c-9-" + i0 + "," + ("3a1daf9c-6-" + i0),
        g: "3a1daf9c-10-" + i0 + "," + ("3a1daf9c-6-" + i0),
        h: index,
        i: "3a1daf9c-6-" + i0 + ",3a1daf9c-0"
      };
    }),
    f: common_vendor.p({
      align: "center"
    }),
    g: common_vendor.sr("table", "3a1daf9c-0"),
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "/Users/birne/Desktop/mp-weixin/src/pages/extUI/table/table.vue"]]);
