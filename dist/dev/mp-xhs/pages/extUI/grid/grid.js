...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    b: common_vendor.f(4, (item, index, i0) => {
      return {
        a: "88ad45ec-4-" + i0 + "," + ("88ad45ec-3-" + i0),
        b: index,
        c: "88ad45ec-3-" + i0 + ",88ad45ec-2",
        d: common_vendor.p({
          index
        })
      };
    ...
    g: common_vendor.f(8, (item, index, i0) => {
      return {
        a: "88ad45ec-8-" + i0 + "," + ("88ad45ec-7-" + i0),
        b: index,
        c: "88ad45ec-7-" + i0 + ",88ad45ec-6",
        d: common_vendor.p({
          index
        })
      };
    ...
    D: common_vendor.f($data.list, (item, index, i0) => {
      return common_vendor.e({
        ...
        d: "88ad45ec-22-" + i0 + "," + ("88ad45ec-21-" + i0),
        e: common_vendor.p({
          text: item.badge,
          type: item.type
        })
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "/Users/birne/Desktop/mp-weixin/src/pages/extUI/grid/grid.nvue"]]);
